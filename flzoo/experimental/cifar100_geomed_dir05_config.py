...
exp_args = dict(
    ...
    group=dict(name='base_group', aggregation_method='generalized', aggregation_alpha=1.0, aggregation_parameters=dict(name='except', keywords=['fc'])),
    other=dict(test_freq=3, logging_path='./logging/experimental/cifar100_geomed_dir05'),
)
