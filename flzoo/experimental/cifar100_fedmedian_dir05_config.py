...
exp_args = dict(
    ...
    group=dict(name='base_group', aggregation_method='median', aggregation_parameters=dict(name='except', keywords=['fc'])),
    other=dict(test_freq=3, logging_path='./logging/experimental/cifar100_fedmedian_dir05'),
)
